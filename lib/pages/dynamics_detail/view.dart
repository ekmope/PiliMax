...
import 'package:PiliMax/common/widgets/refresh_indicator.dart';
...
import 'package:PiliMax/pages/dynamics_detail/controller.dart';
        ...
        Future.delayed(
          ...
          () async {
            ...
            if (res case Success(:final response)) {
              if (mounted) {
                controller.replaceDynItem(response);
              }
            }
          },
        );
