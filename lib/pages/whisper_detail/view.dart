...
import 'package:PiliMax/grpc/bilibili/im/type.pb.dart' show Msg;
...
import 'package:PiliMax/pages/whisper_detail/controller.dart';
import 'package:PiliMax/pages/whisper_detail/widget/chat_item.dart';
import 'package:PiliMax/pages/whisper_link_setting/view.dart';
...
const _kWhisperInputConstraints = BoxConstraints(maxWidth: 625);
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (_whisperDetailController.mid != null) ...[
              ConstrainedBox(
                constraints: _kWhisperInputConstraints,
