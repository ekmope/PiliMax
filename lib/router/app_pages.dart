...
import 'package:PiliMax/pilimax/pages/setting/ai_setting/view.dart';
...
import 'package:PiliMax/pages/blacklist/view.dart';
import 'package:PiliMax/pages/bubble/view.dart';
import 'package:PiliMax/pages/danmaku_block/view.dart';
import 'package:PiliMax/pages/dlna/view.dart';
import 'package:PiliMax/pages/download/view.dart';
import 'package:PiliMax/pages/dynamics/view.dart';
import 'package:PiliMax/pages/dynamics_create_vote/view.dart';
import 'package:PiliMax/pages/dynamics_detail/view.dart';
import 'package:PiliMax/pages/dynamics_topic/view.dart';
import 'package:PiliMax/pages/dynamics_topic_rcmd/view.dart';
import 'package:PiliMax/pages/fan/view.dart';
import 'package:PiliMax/pages/fav/view.dart';
import 'package:PiliMax/pages/fav_create/view.dart';
import 'package:PiliMax/pages/fav_detail/view.dart';
import 'package:PiliMax/pages/fav_search/view.dart';
import 'package:PiliMax/pages/follow/view.dart';
import 'package:PiliMax/pages/follow_search/view.dart';
import 'package:PiliMax/pages/follow_type/follow_same/view.dart';
import 'package:PiliMax/pages/follow_type/followed/view.dart';
import 'package:PiliMax/pages/history/view.dart';
import 'package:PiliMax/pages/history_search/view.dart';
import 'package:PiliMax/pages/home/view.dart';
import 'package:PiliMax/pages/hot/view.dart';
import 'package:PiliMax/pages/later/view.dart';
import 'package:PiliMax/pages/later_search/view.dart';
import 'package:PiliMax/pages/live_dm_block/view.dart';
import 'package:PiliMax/pages/live_room/view.dart';
import 'package:PiliMax/pages/login/view.dart';
import 'package:PiliMax/pages/main/view.dart';
import 'package:PiliMax/pages/main_reply/view.dart';
import 'package:PiliMax/pages/match_info/view.dart';
import 'package:PiliMax/pages/member/view.dart';
import 'package:PiliMax/pages/member_dynamics/view.dart';
import 'package:PiliMax/pages/member_guard/view.dart';
import 'package:PiliMax/pages/member_profile/view.dart';
import 'package:PiliMax/pages/member_search/view.dart';
import 'package:PiliMax/pages/member_upower_rank/view.dart';
import 'package:PiliMax/pages/member_video_web/archive/view.dart';
import 'package:PiliMax/pages/member_video_web/season_series/view.dart';
import 'package:PiliMax/pages/msg_feed_top/at_me/view.dart';
import 'package:PiliMax/pages/msg_feed_top/like_detail/view.dart';
import 'package:PiliMax/pages/msg_feed_top/like_me/view.dart';
import 'package:PiliMax/pages/msg_feed_top/reply_me/view.dart';
import 'package:PiliMax/pages/msg_feed_top/sys_msg/view.dart';
import 'package:PiliMax/pages/music/view.dart';
import 'package:PiliMax/pages/my_reply/view.dart';
import 'package:PiliMax/pages/popular_precious/view.dart';
import 'package:PiliMax/pages/popular_series/view.dart';
...
import 'package:PiliMax/pilimax/pages/video/video_detail_route_page.dart';
  ...
  static final List<GetPage<dynamic>> getPages = [
    ...
    if (BuildConfig.localDiagnostics)
      GetPage(
        ...
        page: () => const LocalDiagnosticsPage(),
      ),
    // 订阅
