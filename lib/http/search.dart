...
import 'package:PiliMax/models/search/suggest.dart';
import 'package:PiliMax/models_new/dynamic/dyn_topic_pub_search/data.dart';
import 'package:PiliMax/models_new/pagelist/page_item.dart';
    ...
    if (res.data['code'] == 0) {
      if (res.data['data'] case List list) {
        final target = part != null
            ...
            : list.firstOrNull;
        if (target != null) {
          return PageItem.fromJson(Map<String, dynamic>.from(target as Map));
        }
      }
      return null;
    } else {
