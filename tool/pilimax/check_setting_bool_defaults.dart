...
void main() {
  final settingDirectories = <Directory>[
    Directory('lib/pages/setting'),
    Directory('lib/pilimax/pages/setting'),
  ].where((directory) => directory.existsSync()).toList();
  if (settingDirectories.isEmpty) {
    _fail('run this command from the repository root');
  }

  final settingSource = settingDirectories
