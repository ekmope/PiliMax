...
- [x] 视频详情页支持“听视频”模式，可后台/锁屏播放，并支持定时关闭和退出控制
- [x] 视频详情页更多面板整合“听视频”和“投屏”入口，减少播放器顶部按钮占用
...
[![Packaging status](https://repology.org/badge/vertical-allrepos/pilimax.svg)](https://repology.org/project/pilimax/versions)
